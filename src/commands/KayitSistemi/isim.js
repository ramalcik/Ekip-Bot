...
run: async (client, message, args, embed, prefix) => { 
    ...
    {
    message.react(red)
    message.lineReply(`\`${prefix}isim <@Ramal/ID> <Isim> <Yaş>\``).then(x=>x.delete({timeout:5000})) 
    return }
...
.setFooter(`Üyesinin önceki isimlerine <!isimler @Ramal/ID> komutuyla bakarak kayıt işlemini gerçekleştirmeniz önerilir.`))
